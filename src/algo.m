function [test_baba,test_baba_opt,test_opt_param]=algo(trainsize,testsize,bw,t_bw,mode_X,mode_Y,X_mu,X_lambda,Y_mu,Y_lambda,varargin)
optimizatin_iter = 5;
...
%     test_Y = GenData(testsize,1,mode_Y,Y_mu,Y_lambda);
    ...
    test_baba(i) = nonWeight([train_X;test_X],[train_Y;test_Y],num.^(-0.2));
    % SIT Test result
